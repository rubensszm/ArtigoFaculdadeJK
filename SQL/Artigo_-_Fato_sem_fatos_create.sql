...
-- Last modification date: 2019-05-10 16:54:41.306
...
-- Table: fato_sem_fatos
CREATE TABLE fato_sem_fatos (
    pk_fato_sem_fatos int  NOT NULL,
    sk_dim_aluno int  NOT NULL,
    sk_dim_disciplina int  NOT NULL,
    sk_dim_data int  NOT NULL,
    sk_dim_instituicao_ensino int  NOT NULL,
    CONSTRAINT fato_sem_fatos_pk PRIMARY KEY (pk_fato_sem_fatos)
);
...
-- Reference: fato_desempenho_escolar_dim_aluno (table: fato_sem_fatos)
ALTER TABLE fato_sem_fatos ADD CONSTRAINT fato_desempenho_escolar_dim_aluno
...
-- Reference: fato_desempenho_escolar_dim_data (table: fato_sem_fatos)
ALTER TABLE fato_sem_fatos ADD CONSTRAINT fato_desempenho_escolar_dim_data
...
-- Reference: fato_desempenho_escolar_dim_disciplina (table: fato_sem_fatos)
ALTER TABLE fato_sem_fatos ADD CONSTRAINT fato_desempenho_escolar_dim_disciplina
...
-- Reference: fato_desempenho_escolar_dim_instituicao_ensino (table: fato_sem_fatos)
ALTER TABLE fato_sem_fatos ADD CONSTRAINT fato_desempenho_escolar_dim_instituicao_ensino
