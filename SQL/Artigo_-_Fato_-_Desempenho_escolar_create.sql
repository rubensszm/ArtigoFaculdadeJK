...
-- Last modification date: 2019-05-10 16:52:58.649
...
-- Table: fato_desempenho_escolar
CREATE TABLE fato_desempenho_escolar (
    pk_fato_desempenho_escolar int  NOT NULL,
    sk_dim_aluno int  NOT NULL,
    sk_dim_disciplina int  NOT NULL,
    sk_dim_data int  NOT NULL,
    sk_dim_instituicao_ensino int  NOT NULL,
    mt_nota_bimestral int  NULL,
    mt_aulas_bimestre int  NULL,
    mt_faltas_bimestre int  NULL,
    CONSTRAINT fato_desempenho_escolar_pk PRIMARY KEY (pk_fato_desempenho_escolar)
);
...
-- Reference: fato_desempenho_escolar_dim_aluno (table: fato_desempenho_escolar)
ALTER TABLE fato_desempenho_escolar ADD CONSTRAINT fato_desempenho_escolar_dim_aluno
...
-- Reference: fato_desempenho_escolar_dim_data (table: fato_desempenho_escolar)
ALTER TABLE fato_desempenho_escolar ADD CONSTRAINT fato_desempenho_escolar_dim_data
...
-- Reference: fato_desempenho_escolar_dim_disciplina (table: fato_desempenho_escolar)
ALTER TABLE fato_desempenho_escolar ADD CONSTRAINT fato_desempenho_escolar_dim_disciplina
...
-- Reference: fato_desempenho_escolar_dim_instituicao_ensino (table: fato_desempenho_escolar)
ALTER TABLE fato_desempenho_escolar ADD CONSTRAINT fato_desempenho_escolar_dim_instituicao_ensino
