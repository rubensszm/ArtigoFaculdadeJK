...
-- Last modification date: 2019-05-10 16:53:44.816
...
-- Table: fato_evasao_escolar
CREATE TABLE fato_evasao_escolar (
    pk_fato_evasao_escolar int  NOT NULL,
    sk_dim_aluno int  NOT NULL,
    sk_dim_disciplina int  NOT NULL,
    sk_dim_data int  NOT NULL,
    sk_dim_instituicao_ensino int  NOT NULL,
    mt_situacao_evasao int  NULL,
    CONSTRAINT fato_evasao_escolar_pk PRIMARY KEY (pk_fato_evasao_escolar)
);
...
-- Reference: fato_desempenho_escolar_dim_aluno (table: fato_evasao_escolar)
ALTER TABLE fato_evasao_escolar ADD CONSTRAINT fato_desempenho_escolar_dim_aluno
...
-- Reference: fato_desempenho_escolar_dim_data (table: fato_evasao_escolar)
ALTER TABLE fato_evasao_escolar ADD CONSTRAINT fato_desempenho_escolar_dim_data
...
-- Reference: fato_desempenho_escolar_dim_disciplina (table: fato_evasao_escolar)
ALTER TABLE fato_evasao_escolar ADD CONSTRAINT fato_desempenho_escolar_dim_disciplina
...
-- Reference: fato_desempenho_escolar_dim_instituicao_ensino (table: fato_evasao_escolar)
ALTER TABLE fato_evasao_escolar ADD CONSTRAINT fato_desempenho_escolar_dim_instituicao_ensino
